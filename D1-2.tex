...
Sensor Collector with improved Performance and Battery Awareness
HAR component fully integrated with up to 85 accuracy.
SLD component with 
...
% * Presented Sensor Collection Service in last deliverable
%   Improved architecture in several ways
% 
% * Provide Methods for 
%   - Mobile Sensor Mining Component
%   - Serverside Mining Component
